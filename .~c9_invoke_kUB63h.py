...
#need help here with  sending the url. confirm_url now just has /confirm/"user_id". Think we need to code in the dcyphr.org ling and add
#/confirm/id to the end
                html_content='<a href={{ confirm_url }}>Click to confirm your dcyphr account.</a>')
            try:
